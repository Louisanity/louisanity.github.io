...
<style>
  ...
  /* Replace the old decorative orbit/circuit arc with a designed Bloch-sphere motif. */
  ...
  html[data-theme="dark"] .lc-home-refined .lc-bloch-label {
    text-shadow: none;
  }

  .lc-home-refined .lc-bloch-label--zero {
    left: 48%;
    top: 7%;
  }

  .lc-home-refined .lc-bloch-label--one {
    left: 49%;
    bottom: 7%;
  }

  .lc-home-refined .lc-bloch-label--psi {
    right: 18%;
    top: 24%;
  }
...
<div class="lc-modern-home lc-home-refined">
  <section class="lc-hero" aria-label="Homepage introduction">
    ...
    <div class="lc-bloch-sphere" aria-hidden="true">
      ...
      <span class="lc-bloch-label lc-bloch-label--zero">|0⟩</span>
      <span class="lc-bloch-label lc-bloch-label--one">|1⟩</span>
      <span class="lc-bloch-label lc-bloch-label--psi">|ψ⟩</span>
    </div>
  </section>
